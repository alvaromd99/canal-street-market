...
function App() {
	...
	const [matchFood] = useRoute('/food')
	const [matchFoodName] = useRoute('/food/:name')
	const [matchRetail] = useRoute('/retail')
	const [matchCommunity] = useRoute('/community')

	const isMatched =
		matchHome || matchFood || matchFoodName || matchRetail || matchCommunity
